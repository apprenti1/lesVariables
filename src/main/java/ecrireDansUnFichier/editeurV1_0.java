...
*/
public class editeurV1_0 {
    public editeurV1_0() throws FileNotFoundException {
    }
            ...
            */
            ...
            while (stop == false) {
                ...
                if (enter.startsWith("!stop")) {
                    ...
                    try {
                        FileDialog hh = new FileDialog((Frame) null);
                        hh.setVisible(true);
                    ...
                    for (int i = 0; i <30; i++) {
                        System.out.print("\n\t\t");
                        for (int j = 0; j <200; j++) {
                            System.out.print("\u001B[38;2;90;"+(int)(((float)i)/30*255)+";"+(int)(((float)j)/200*255)+"m\u001B[1m█\u001B[0m");
                        }
                    }
                    System.out.println("\n");
                }
